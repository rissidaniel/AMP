...
# reference: https://github.com/RichieJu520/Co-occurrence_Network_Analysis
# devtools::install_github("schuyler-smith/phyloschuyler", dependencies = TRUE)
library(phylosmith)
library(phyloseq)

setwd("c:/Users/danie/Desktop/Co-occurrence_Network_Analysis-master/Co-occurrence_Network_Analysis-master/example/")
